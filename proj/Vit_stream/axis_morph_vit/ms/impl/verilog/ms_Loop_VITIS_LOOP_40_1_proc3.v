...
module ms_Loop_VITIS_LOOP_40_1_proc3 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_block_state2;
wire   [0:0] temp_in_packet_last_V_fu_70_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((in_raw_stream_full_n == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0)) & (temp_in_packet_last_V_fu_70_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((in_raw_stream_full_n == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0)) & (temp_in_packet_last_V_fu_70_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign temp_in_packet_last_V_fu_70_p1 = in_stream_TLAST_int_regslice;

endmodule //ms_Loop_VITIS_LOOP_40_1_proc3
