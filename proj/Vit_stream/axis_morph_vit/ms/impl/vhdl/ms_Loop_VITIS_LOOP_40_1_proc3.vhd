...
entity ms_Loop_VITIS_LOOP_40_1_proc3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ms_Loop_VITIS_LOOP_40_1_proc3 is 
...
attribute shreg_extract : string;
    ...
    signal temp_in_packet_last_V_fu_70_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, in_raw_stream_full_n, ap_CS_fsm_state2, temp_in_packet_last_V_fu_70_p1, in_stream_TVALID_int_regslice)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((in_raw_stream_full_n = ap_const_logic_0) or (in_stream_TVALID_int_regslice = ap_const_logic_0))) and (temp_in_packet_last_V_fu_70_p1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif ((not(((in_raw_stream_full_n = ap_const_logic_0) or (in_stream_TVALID_int_regslice = ap_const_logic_0))) and (temp_in_packet_last_V_fu_70_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    temp_in_packet_last_V_fu_70_p1 <= in_stream_TLAST_int_regslice;
end behav;
