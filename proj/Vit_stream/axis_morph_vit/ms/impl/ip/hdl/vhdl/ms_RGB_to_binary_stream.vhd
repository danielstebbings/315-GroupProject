...
architecture behav of ms_RGB_to_binary_stream is 
    ...
    constant ap_const_lv21_1FBB74 : STD_LOGIC_VECTOR (20 downto 0) := "111111011101101110100";
    constant ap_const_lv21_1FBB73 : STD_LOGIC_VECTOR (20 downto 0) := "111111011101101110011";
...
begin
    ...
    icmp_ln14_fu_155_p2 <= "1" when (pixel_reg_113 = ap_const_lv21_1FBB74) else "0";
    ...
    temp_BW_pkt_last_fu_161_p2 <= "1" when (pixel_reg_113 = ap_const_lv21_1FBB73) else "0";
