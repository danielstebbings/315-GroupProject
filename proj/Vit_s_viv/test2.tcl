...
#
# test2.tcl: Tcl script for re-creating project 'test2'
#
# Generated by Vivado on Thu Apr 25 12:53:54 +0100 2024
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
   [file normalize "$origin_dir/../vImp/ms"] \
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Downloads/temp/temp/test2"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../vImp/ms"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: ms_0, and set properties
  set ms_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ms:1.0 ms_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins ms_0/in_stream]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ms_0_out_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins ms_0/out_stream]
connect_bd_intf_net -intf_net [get_bd_intf_nets ms_0_out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ms_0_out_stream]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ms_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ms_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net ms_0_interrupt [get_bd_pins ms_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins ms_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ms_0/s_axi_control/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.25",
   "Default View_TopLeft":"331,15",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 8 -x 2620 -y 340 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 8 -x 2620 -y 360 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 2150 -y 390 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 840 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1380 -y 340 -defaultsOSRD
preplace inst ms_0 -pg 1 -lvl 3 -x 960 -y 290 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 530 -y 580 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -x 1760 -y 370 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 3 -x 960 -y 470 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -x 530 -y 90 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 7 -x 2500 -y 150 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 30 740 NJ 740 NJ 740 NJ 740 NJ 740 NJ 740 2380
preplace netloc ARESETN_1 1 1 6 380 750 730 190 1140 190 1590 190 N 190 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 20 660 370 420 750 200 1130 460 1580 220 1920 220 2400
preplace netloc xlconcat_0_dout 1 2 1 700 90n
preplace netloc axi_intc_0_irq 1 3 3 1150J 210 NJ 210 1910
preplace netloc axi_dma_0_mm2s_introut 1 1 4 370 10 NJ 10 NJ 10 1560
preplace netloc axi_dma_0_s2mm_introut 1 1 4 370 170 690J 160 NJ 160 1550
preplace netloc ms_0_interrupt 1 1 3 380 180 NJ 180 1120
preplace netloc processing_system7_0_DDR 1 6 2 NJ 340 N
preplace netloc ms_0_out_stream 1 3 4 1170 130 N 130 N 130 N
preplace netloc processing_system7_0_FIXED_IO 1 6 2 NJ 360 N
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 5 760 120 NJ 120 1570 110 N 110 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 380 190 680J 150 NJ 150 NJ 150 NJ 150 2380
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 2 720 380 1160J
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 5 710 170 N 170 N 170 N 170 2390
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 N 280
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 N 370
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 300
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 740 440n
levelinfo -pg 1 0 200 530 960 1380 1760 2150 2500 2620
pagesize -pg 1 -db -bbox -sgen 0 0 2740 940
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Downloads/temp/temp/test2/test2.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
