...
HD_PWD='C:/Xil_proj/315/proj/DIY/imp/imp.runs/d1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d1_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d1_processing_system7_0_0.tcl
