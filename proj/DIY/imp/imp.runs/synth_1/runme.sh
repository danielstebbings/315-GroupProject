...
HD_PWD='C:/Xil_proj/315/proj/DIY/imp/imp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d1_wrapper.tcl
