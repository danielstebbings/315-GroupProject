...
HD_PWD='C:/Xil_proj/315/proj/DIY/imp/imp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d1_wrapper.tcl -notrace
